...
class EditClinic:
    ...
    def edit_clinic(self):
        try:
            if self.page.locator("//img[@src='./assets/images/edit.png']").is_visible(timeout=5000):
                self.page.locator("//img[@src='./assets/images/edit.png']").first.click()
            elif self.page.locator("//tbody/tr[1]/td[5]/div[1]/img[1]").is_visible(timeout=5000):
                self.page.locator("//tbody/tr[1]/td[5]/div[1]/img[1]").click()
            else:
                raise Exception("Neither edit icon was found.")
